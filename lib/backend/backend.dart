...
import 'schema/studycourse_record.dart';
...
export 'schema/studycourse_record.dart';
...
/// Functions to query StudycourseRecords (as a Stream and as a Future).
Future<int> queryStudycourseRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      StudycourseRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<StudycourseRecord>> queryStudycourseRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      StudycourseRecord.collection,
      StudycourseRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<StudycourseRecord>> queryStudycourseRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
