...
String? getCountryFlag(String? countryName) {
  ...
  final countryInfoJson = {
    ...
    "The Democratic Republic of the Congo": {"dial_code": "+243", "code": "CD"},
    ...
    "Korea": {"dial_code": "+850", "code": "KP"},
    "South Korea": {"dial_code": "+82", "code": "KR"},
    ...
    "Micronesia": {"dial_code": "+691", "code": "FM"},
    ...
    "Saint Helena": {"dial_code": "+290", "code": "SH"},
    ...
    "South Georgia": {"dial_code": "+500", "code": "GS"},
  ...
  if (countryCode != null) {
    ...
    return 'https://flagcdn.com/20x15/$countryCodeInLowerCase.png';
  }
...
String? getCountryCode(String? countryName) {
  ...
  final countryCode = countryInfoJson[countryName]?["dial_code"];
...
int? getAgeFromDate(DateTime birthDate) {
  // Differenz zwischen heute und Geburtsdatum berechnen
...
bool? isGenderInSearch(
  ...
  return genderList.contains(genderToSearch);
}
